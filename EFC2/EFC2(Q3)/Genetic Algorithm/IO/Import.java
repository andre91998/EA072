...
public class Import {
    ...
    public static City[] getCities (DataSet dataSet) {
        ...
        //System.out.println(words[words.length-1].getClass().getName()); //auxilary prints to try to resolve error with original code
        //System.out.println("here's words[words.length-1]:");
        //System.out.println(words[words.length-1]);
        //int numOfCities = Integer.parseInt(words[words.length-1]);//original code. Is not working for unknown reason, regarding the parsing of the number of cities
        int numOfCities = 48;
